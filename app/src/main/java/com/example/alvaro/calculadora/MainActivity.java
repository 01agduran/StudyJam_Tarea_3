...
private  String expresion="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txvUno=(TextView)findViewById(R.id.txv_uno);
        txvDos=(TextView)findViewById(R.id.txv_dos);
        txvTres=(TextView)findViewById(R.id.txv_tres);
        txvCuatro=(TextView)findViewById(R.id.txv_cuatro);
        txvCinco=(TextView)findViewById(R.id.txv_cinco);
        txvSeis=(TextView)findViewById(R.id.txv_seis);
        txvSiete=(TextView)findViewById(R.id.txv_siete);
        txvOcho=(TextView)findViewById(R.id.txv_ocho);
        txvNueve=(TextView)findViewById(R.id.txv_nueve);
        txvCero=(TextView)findViewById(R.id.txv_cero);

        txvSumar=(TextView)findViewById(R.id.txv_sumar);
        txvRestar=(TextView)findViewById(R.id.txv_restar);
        txvMultiplicar=(TextView)findViewById(R.id.txv_multiplicar);
        txvDividir=(TextView)findViewById(R.id.txv_dividir);

        txvComa=(TextView)findViewById(R.id.txv_coma);
        txvCE=(TextView)findViewById(R.id.txv_ce);

        txvResultado=(TextView)findViewById(R.id.txv_reultado);
